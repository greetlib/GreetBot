...
class AuthenticationModule extends GreetBotModule {
    ...
    private void addUser(Command c) {
        ...
        if(target == "global") userData.globalAccess = [accessLevel: c.args[3]] as AccessPrivilege
        else userData.channelAccess.put(target, [accessLevel: c.args[3]] as AccessPrivilege)
        ...
        c.messageEvent.connection.sendMessage(c.args[0], "To authenticate a new host use the 'auth' command.")
